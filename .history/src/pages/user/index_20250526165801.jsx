...
import { Button, Form, Input, Table, Popconfirm, Modal, InputNumber, Select } from "antd";
import "../../css/user.css";
    ...
    <div className="user-user">
      <div className="flex-box">
        ...
        <Form layout="inline" onFinish={handleFinish}>
          <Form.Item name="keyword">
            <InputNumber placeholder="请输入用户名" />
          </Form.Item>
      ...
      >
        <Form form={form} labelCol={{ span: 6 }} wrapperCol={{ span: 18 }} labelAlign="left">
          ...
          <Form.Item label="性别" name="name" rules={[{ required: true, message: "请输入性别" }]}>
            <Select
              placeholder="请选择性别"
              options={[
                {
          ...
          <Form.Item label="出生日期" name="name" rules={[{ required: true, message: "请输入出生日期" }]}>
