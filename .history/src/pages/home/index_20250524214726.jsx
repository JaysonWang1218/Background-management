    ...
    return (
        <Row className="home">
            ...
            <Col span={16}>
                ...
                {echartsData.order&&<MyEcharts charData={echartsData.order} style={{height:'280px'}}/>}
                <div className="graph">
                    {echartsData.user&&<MyEcharts charData={echartsData.user} style={{height:'280px'}} isAxisChart={false}/>}
                    {echartsData.video&&<MyEcharts charData={echartsData.video} style={{height:'280px'}} isAxisChart={false}/>}
                </div>
            </Col>
        </Row>
    );
