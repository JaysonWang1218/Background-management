  ...
  return (
    <Row className="home">
      ...
      <Col span={16}>
        ...
        <div className="graph">
          {echartsData.user && <MyEcharts charData={echartsData.user} style={{ height: "240px", width: "50%" }} />}
          {echartsData.video && (
            <MyEcharts charData={echartsData.video} isAxisChart={false} style={{ height: "260px", width: "50%" }} />
          )}
        </div>
      </Col>
    </Row>
