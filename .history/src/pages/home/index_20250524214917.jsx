    ...
    return (
        <Row className="home">
            ...
            <Col span={16}>
                ...
                <div className="graph">
                    {echartsData.user&&<MyEcharts charData={echartsData.user} style={{height:'240px'}} isAxisChart={false}/>}
                    {echartsData.video&&<MyEcharts charData={echartsData.video} style={{height:'240px'}} isAxisChart={false}/>}
                </div>
            </Col>
        </Row>
    );
